...
# el proceso es que si un numero es par se divide por 2 sino es par se multiplica por 3 y se le suma 1, eventualmente todo numero llegara a 1
# el programa debe:
...
while c0 != 1: # nuestro goal es llegar a 1
